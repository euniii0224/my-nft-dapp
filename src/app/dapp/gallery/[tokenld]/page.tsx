...
export default function NftDetailPage() {
  ...
  const imageRaw =
    metadataQuery.data && typeof metadataQuery.data.image === 'string'
      ? metadataQuery.data.image
      : ''

  const name =
    metadataQuery.data && typeof metadataQuery.data.name === 'string'
      ? metadataQuery.data.name
      : ''

  const description =
    metadataQuery.data && typeof metadataQuery.data.description === 'string'
